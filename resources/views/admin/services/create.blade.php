            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title_zh" id="title_zh" class="form-control" value="{{ old('title_zh') }}">
                    </div>
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description_zh" id="description_zh" class="form-control" rows="8">{{ old('description_zh') }}</textarea>
                    </div>

                    <div class="form-group">
                        <label for="image">Ảnh chính</label>
                        <input type="file" name="image" id="image" class="form-control" accept="image/*" onchange="previewImage(this, 'preview-image')">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <div>
                        <div class="form-group">
                            ...
                            <input type="text" name="title1" id="title1" class="form-control" value="{{ old('title1') }}">
                        </div>
                        <div class="form-group">
                            <label for="title1_en">Tiêu đề Section 1 (Tiếng Anh)</label>
                            <input type="text" name="title1_en" id="title1_en" class="form-control" value="{{ old('title1_en') }}">
                        </div>
                        <div class="form-group">
                            <label for="title1_zh">Tiêu đề Section 1 (Tiếng Trung)</label>
                            <input type="text" name="title1_zh" id="title1_zh" class="form-control" value="{{ old('title1_zh') }}">
                        </div>
                    </div>
                    <div>
                        <div class="form-group">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <div>
                        <div class="form-group">
                            ...
                            <input type="text" name="title{{ $i }}" id="title{{ $i }}" class="form-control" value="{{ old("title{$i}") }}">
                        </div>
                        <div class="form-group">
                            <label for="title{{ $i }}_en">Tiêu đề (Tiếng Anh)</label>
                            <input type="text" name="title{{ $i }}_en" id="title{{ $i }}_en" class="form-control" value="{{ old("title{$i}_en") }}">
                        </div>
                        <div class="form-group">
                            <label for="title{{ $i }}_zh">Tiêu đề (Tiếng Trung)</label>
                            <input type="text" name="title{{ $i }}_zh" id="title{{ $i }}_zh" class="form-control" value="{{ old("title{$i}_zh") }}">
                        </div>
                    </div>
                    <div>
                        <div class="form-group">
                            <label for="description{{ $i }}">Mô tả (Tiếng Việt)</label>
                            <textarea name="description{{ $i }}" id="description{{ $i }}" class="form-control" rows="6">{{ old("description{$i}") }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="description{{ $i }}_en">Mô tả (Tiếng Anh)</label>
                            <textarea name="description{{ $i }}_en" id="description{{ $i }}_en" class="form-control" rows="6">{{ old("description{$i}_en") }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="description{{ $i }}_zh">Mô tả (Tiếng Trung)</label>
                            <textarea name="description{{ $i }}_zh" id="description{{ $i }}_zh" class="form-control" rows="6">{{ old("description{$i}_zh") }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="image{{ $i }}">Ảnh</label>
                            <input type="file" name="image{{ $i }}" id="image{{ $i }}" class="form-control" accept="image/*" onchange="previewImage(this, 'preview-image{{ $i }}')">
